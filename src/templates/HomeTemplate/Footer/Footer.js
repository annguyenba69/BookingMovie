        ...
        <div className="grid grid-cols-12">
          <div className="pb-6 col-span-full md:pb-0 md:col-span-6">
            <a rel="noopener noreferrer" href="#" className="flex justify-center space-x-3 md:justify-start">
              ...
              <span className="self-center text-2xl font-semibold">Booking Movie</span>
            </a>
          </div>
          <div className="col-span-6 text-center md:text-left md:col-span-3">
            <p className="pb-1 text-lg font-medium">VỀ BOOKING MOVIE STAR</p>
            <ul>
              <li>
                <NavLink to={"/about"} rel="noopener noreferrer" className="hover:dark:text-violet-400">About</NavLink>
              </li>
              <li>
                <NavLink to={"/advertise"} rel="noopener noreferrer" className="hover:dark:text-violet-400">Advertise</NavLink>
              </li>
            </ul>
          </div>
        </div>
